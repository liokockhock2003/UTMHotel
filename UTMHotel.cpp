...
void ReservationList::DisplayReservationList()
{
    ...
    cout << endl
         << "Reservation List" << endl
         << left
         << setw(10) << "Cust. ID"
         << setw(10) << "Resv. ID"
         << setw(15) << "Room Number"
         << setw(10) << "Resv. Date" << endl;
    while (currNode != NULL)
    {
        cout << left
             << setw(10) << currNode->getCustomerId()
             << setw(10) << currNode->getReservationId()
             << setw(15) << currNode->getRoomNumber();
        for (int i = 0; i < 3; i++)
        {
            if (i < 2)
            {
                cout << right
                     << setw(2) << currNode->getReservationDate(i) << "/";
            }
            else
            {
                cout << right
                     << setw(2)
                     << currNode->getReservationDate(i);
            }
        }
        cout << endl;
        currNode = currNode->next;
...
void CustomerList::DisplayCustomerList()
{
    ...
    while (currNode != NULL)
    {
        cout << left
             << setw(10) << currNode->getCustomerId()
             << setw(20) << currNode->getName()
             << setw(15) << currNode->getContact();
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            {
                cout << right
                     << setw(2) << currNode->getCheckInDate(i) << "/";
            }
            else
            {
                cout << right
                     << setw(4) << currNode->getCheckInDate(i);
            }
        }
        cout << setw(5) << " ";
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            {
                cout << right
                     << setw(2) << currNode->getCheckOutDate(i) << "/";
            }
            else
            {
                cout << right
                     << setw(4) << currNode->getCheckOutDate(i);
            }
        }
        cout << setw(5) << " ";
...
int CustomerList::FindNode(int x)
{
    Customer *currNode = head;
    int currIndex = 1;

    while (currNode && currNode->getCustomerId() != x)
    {
        currNode = currNode->next;
        currIndex++;
    }
...
int CustomerList::DeleteNode(int custId)
{
    Customer *prevNode = NULL;
    Customer *currNode = head;
    int currIndex = 1;
